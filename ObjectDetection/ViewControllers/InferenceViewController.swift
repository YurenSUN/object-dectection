...
class InferenceViewController: UIViewController {
  ...
  enum Action {
    ...
    case changeModel(ModelTypeAttribute)
  }
  ...
  private var modelSelect: ModelTypeAttribute {
    if modelSelectIndex < ModelTypeAttribute.allCases.count {
      return ModelTypeAttribute.allCases[modelSelectIndex]
    } else {
      return .resnet50attr
    }
  }
...
extension InferenceViewController: UIPickerViewDelegate, UIPickerViewDataSource {
  ...
  func pickerView(_ pickerView: UIPickerView, numberOfRowsInComponent component: Int) -> Int {
    return ModelTypeAttribute.allCases.count
  }

  func pickerView(_ pickerView: UIPickerView, titleForRow row: Int, forComponent component: Int)
    -> String?
  {
    if row < ModelTypeAttribute.allCases.count {
      return ModelTypeAttribute.allCases[row].title
    } else {
      return nil
    }
  }
